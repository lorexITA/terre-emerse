...
- La città è conosciuta in tutto l'impero per il castello del governatore completamente fatto in una strana roccia nera con venature dorate
- La città esporta enormi quantità di pesce, prelibatezza per i cittadini di [[DALICO]]
...
Nel 142, dopo che fu costruito il [[TEMPIO A STACIA]], i costruttori trovarono poco più a nord una particolare formazione di roccia nera con venature dorate. Vedendolo come un segno divino, decisero di erigere un castello interamente fatto di quel materiale e stabilirsi nei dintorni. Ben presto si creò una città.
