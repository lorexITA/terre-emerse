...
tags:
  - "#Location"
  - "#Settlement"
art: MAPPE/CITTA'/roccasparvera.png
settlementtype: Thorp
aliases:
  - Città morta
terrain:
  - Coastline
...
> [!recite]- Introduction
> Non ricevete un caloroso benvenuto a Roccasparvera: l'unica cosa che si può notare è l'enorme castello abbandonato che torreggia in cima ad una collina. Il resto delle strade e degli edifici è incredibilmente trascurato
...
- Gran parte della città è abbandonata
- C'è un castello enorme in cima alla collina, chiamato come la città, anch'esso disabitato
- I cittadini non vogliono entrare nei luoghi abbandonati
...
Nessuno sa la storia che circonda questo luogo, i primi resoconti storici che lo nominano danno per scontata la sua esistenza.
